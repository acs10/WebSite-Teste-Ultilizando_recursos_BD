	...
	<nav class="gtco-nav" role="navigation">
		<div class="gtco-container">		
			<div class="row">
				...
				<div id="gtco-logo"><a href="">TicketBus <em>.</em></a></div>
				</div>
			</div>
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Welcome to TicketBus</span>
							<h1>Adquira já sua Passagem, sem sair de casa.</h1>	
						</div>
						<div class="col-md-4 col-md-push-1 animate-box" data-animate-effect="fadeInRight">
							<div class="form-wrap">
								<div class="tab">
									<ul class="tab-menu">
										<li class="active gtco-first"><a href="#" data-tab="signup">Entrar</a></li>
										<li class="gtco-second"><a href="#" data-tab="login">Cadastre-se</a></li>
									</ul>
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
										<form action="entrar.php" enctype="multipart/form-data" method="post">
										...
										<div class="tab-content-inner" data-content="login">
										    <form action="cadastrar.php" method="post">
												...
												<div class="row form-group">
													<div class="col-md-12">
														<label for="password">Password</label>
														<input type="password" name="senha"class="form-control"  placeholder=" Repeat Password" />
													</div>
												</div>
